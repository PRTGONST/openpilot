...
void HomeWindow::mousePressEvent(QMouseEvent* e) {
  ...
  if (controls_state.getSpeedLimit() > 0.0 &&
  ...
  // Issue a debug print.
    ...
    int size = snprintf(s, sizeof(s), 
      ...
      turn_speeds_ahead_s,
      controls_state.getSpeedLimit() * 3.6, controls_state.getSpeedLimitControlState(), controls_state.getIsMapSpeedLimit(),
      controls_state.getTurnSpeed() * 3.6, controls_state.getTurnSpeedControlState(),
      controls_state.getTurnAcc(), controls_state.getTurnControllerState());
